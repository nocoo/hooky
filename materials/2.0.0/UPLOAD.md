# Hooky 2.0.0 — Upload guide

1. Complete [manual acceptance](TESTING.md), then upload `hooky-2.0.0.zip` to the existing [Chrome Web Store listing](https://chromewebstore.google.com/detail/hooky/almccnkbhfhckimediabjimflnbfbeeo).
2. Use the English name, short description and full description in `store/text/`. Short description: 98/132 characters.

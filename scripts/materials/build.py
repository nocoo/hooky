...
{manual}
Automated checks: {count} unit tests, the existing coverage gates, lint, repository E2E/workflow tests, and the production build passed. See [verification/build.json](verification/build.json) and its logs. {report['network_boundary']} Native paste interaction, OS notifications, and your own receiving service remain part of manual acceptance.
